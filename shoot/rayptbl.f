...
ccccc  1.10.2012  RWP/CC 1.10.2012 - arsinoe was retired so the background models are relocated
c        fnm='/home/arsinoe/rallen/software/tomoregionalBD/data/iasp/rayp.'//pha(iraytype)(1:lp)//'.out'
c        fnm='/data/seismo86/dna/software/tomoregionalBD/data/iasp/rayp.'//pha(iraytype)(1:lp)//'.out'
        fnm='/data/dna/software/tomoregionalBD/data/iasp/rayp.'//pha(iraytype)(1:lp)//'.out'
        write(6,*)fnm

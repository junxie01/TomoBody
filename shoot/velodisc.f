...
cccccc RWP/CC 1.10.2012 - arsinoe was retired so the background models are relocated
c         open(22,file='/home/arsinoe/rallen/software/tomoregionalBD/data/ak135-c.model')
c         open(22,file='/data/seismo86/dna/software/tomoregionalBD/data/ak135-c.model')
         open(22,file='/data/dna/software/tomoregionalBD/data/ak135-c.model')
...
cccccc RWP/CC 1.10.2012 - arsinoe was retired so the background models are relocated
c         open(22,file='/data/seismo86/dna/software/tomoregionalBD/data/ak135-c.model')
c         open(22,file='/home/arsinoe/rallen/software/tomoregionalBD/data/ak135-o.model')
         open(22,file='/data/dna/software/tomoregionalBD/data/ak135-c.model')
         read(22,*)mdn,nlak
         do ir=1,nlak
            read(22,*)akr(ir),rho,akc(ir,1),akc(ir,2)
